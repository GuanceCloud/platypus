...
import (
	...
	"github.com/GuanceCloud/platypus/pkg/inimpl/guancecloud/ptinput/refertable"
...
func TestQueryReferTable(t *testing.T) {
	...
	defer cancel()
	refertable.InitReferTableRunner(ctx, url+"?name=a.json", "", time.Second*5, false, false)
